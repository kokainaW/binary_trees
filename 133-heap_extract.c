...
/**
 * max - It finds the maximum node in a tree.
 * @tree: The pointer to the root of the tree.
 * Return: The node with the maximum value.
 */
void heap_t *max(heap_t *tree)
{
...
/**
 * recurse_extract - It is recursively extracts the max from the tree.
 * @tree: The pointer to the root of the tree.
 */
...
/**
 * heap_extract - It extracts the root from a Binary Heap.
